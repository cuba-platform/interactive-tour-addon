package com.haulmont.addon.tour.tour_parser;
...
public class TourParserTest extends CubaClientTestCase {
    ...
    public void parseCorrectTourFromJson() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/correctTour.json");
    ...
    public void validateIncorrectAttachTo() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectAttachTo.json");
    ...
    public void validateIncorrectAnchor() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectAnchor.json");
    ...
    public void validateIncorrectTextContentMode() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectTextContentMode.json");
    ...
    public void validateIncorrectTitleContentMode() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectTitleContentMode.json");
    ...
    public void validateIncorrectWidth() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectWidth.json");
    ...
    public void validateIncorrectHeight() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectHeight.json");
    ...
    public void validateEmptyId() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/emptyId.json");
    ...
    public void validateEmptyCaption() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/emptyCaption.json");
    ...
    public void validateIncorrectAction() {
        String file = resources.getResourceAsString("com/haulmont/addon/tour/tour_parser/json_data/incorrectAction.json");
